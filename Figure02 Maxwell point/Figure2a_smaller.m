...
annotation('textbox',...
    [0.236280257936502 0.379761904761907 0.0940768849206403 0.0990851415757897],...
    'String','$Q_{-}$',...
    'Interpreter','latex',...
    'FontSize',24,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation('textbox',...
    [0.560015376984119 0.376190476190477 0.0873060515873092 0.101767711724769],...
    'String','$Q_{0}$',...
    'Interpreter','latex',...
    'FontSize',24,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation('textbox',...
    [0.758353670634911 0.373809523809524 0.0827177579365167 0.105436507197039],...
    'String','$Q_{+}$',...
    'Interpreter','latex',...
    'FontSize',24,...
    'FitBoxToText','off',...
