...
annotation('textbox',...
    [0.243423115079359 0.379761904761907 0.0940768849206403 0.0990851415757897],...
    'String','$Q_{-}$',...
    'Interpreter','latex',...
    'FontSize',24,...
    'FitBoxToText','off',...
...
annotation('textbox',...
    [0.455551091269833 0.367857142857143 0.0873060515873092 0.101767711724769],...
    'String','$Q_{0}$',...
    'Interpreter','latex',...
    'FontSize',24,...
    'FitBoxToText','off',...
...
annotation('textbox',...
    [0.792282242063483 0.369047619047619 0.0827177579365167 0.105436507197039],...
    'String','$Q_{+}$',...
    'Interpreter','latex',...
    'FontSize',24,...
    'FitBoxToText','off',...
